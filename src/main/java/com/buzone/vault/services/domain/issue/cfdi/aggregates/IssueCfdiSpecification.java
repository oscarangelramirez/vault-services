...
public class IssueCfdiSpecification implements Specification<IssueCfdi> {
	private static final long serialVersionUID = 1L;
	
	private List<SearchCriteria> list;
	
	public IssueCfdiSpecification() {
	...
	@Override
	public Predicate toPredicate(Root<IssueCfdi> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
